...
Collision checks take the form =touching(my_collider_type,my_side,their_collider_type)=; =my_side= is optional (see [[Colliders and collision]] for more details on collider types).
